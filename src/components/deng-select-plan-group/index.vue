...
<script>
	...
	export default {
	  ...
	  watch: {
		...
		pop(value){
			if(value){this.initData(this.ProjectGUID)}
		}
	  },
	  created() {
		console.log(11111)
	  ...
	  methods: {
		initData(ProjectGUID){
			let that = this
			console.log(111,ProjectGUID)
			if(!ProjectGUID){that.$message({message: '请选取项目名称!',type: 'error'});return;}
