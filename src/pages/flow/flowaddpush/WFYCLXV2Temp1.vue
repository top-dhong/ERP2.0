      ...
      <el-row>
        <el-col :span="24">
          <el-form :model="flowData" ref="flowData" label-position="left" label-width="110px" class="demo-ruleForm" size="mini">
            ...
            <el-row>
			 <el-col :span="12">
			  <el-form-item label="业务类型：" class="te-item" prop="flowCoreData.text6" :rules="[{ required: true, message: '营销相关不能为空',trigger:'blur'}]">	 
			   <el-select
						   v-model="flowData.flowCoreData.text6"
						   placeholder="选择业务"
						   style="width: 150px"
						 >
						   <el-option label="印刷类" value="36500" />
						   <el-option label="活动类" value="90" />
						   <el-option label="发布类" value="30" />
						 </el-select>
			    </el-form-item> 
			</el-col>
			<el-col :span="12">
			  <el-form-item label="框架合同：" class="te-item" prop="flowCoreData.text15" :rules="[{ required: true, message: '是否为框架合同',trigger:'blur'}]">
			    <el-radio-group v-model="flowData.flowCoreData.text15" :disabled="(Flg=='VIEW')">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="核价类型：" class="te-item" prop="flowCoreData.text21" :rules="[{ required: true, message: '核价类型不能为空',trigger:'blur'}]">
                  <el-radio-group v-model="flowData.flowCoreData.text21" :disabled="(Flg=='VIEW')">
			...
			<el-col :span="12">
			  <el-form-item label="是否人事：" class="te-item" prop="flowCoreData.text22" :rules="[{ required: true, message: '是否人事不能为空',trigger:'blur'}]">
			    <el-radio-group v-model="flowData.flowCoreData.text22" :disabled="(Flg=='VIEW')">
			      <el-radio label="是"></el-radio>
			      <el-radio label="否"></el-radio>
			    </el-radio-group>
			  </el-form-item>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="是否月度：" class="te-item" prop="flowCoreData.text50" :rules="[{ required: true, message: '是否月度立项不能为空',trigger:'blur'}]">
		...
		<el-col :span="12">
		  <el-form-item label="地产相关：" class="te-item" prop="flowCoreData.text33" :rules="[{ required: true, message: '是否地产相关',trigger:'blur'}]">
		    <el-radio-group v-model="flowData.flowCoreData.text33" :disabled="(Flg=='VIEW')">
		      <el-radio label="是"></el-radio>
		      <el-radio label="否"></el-radio>
		    </el-radio-group>
		  </el-form-item>
			 ...
			 <el-col :span="12">
			   <el-form-item label="资产采购：" class="te-item" prop="flowCoreData.text11" :rules="[{ required: true, message: '是否资产采购',trigger:'blur'}]">
			     <el-radio-group v-model="flowData.flowCoreData.text11" :disabled="(Flg=='VIEW')">
			       <el-radio label="是"></el-radio>
			       <el-radio label="否"></el-radio>
			     </el-radio-group>
			   </el-form-item>
            ...
            <el-row>
				<el-col :span="12">
				  <el-form-item label="预算审批人：" class="te-item" prop="flowCoreData.hrs5" :rules="[{ required: true, message: '预算审批人',trigger:'blur'}]">
					<el-input placeholder="预算审批人" v-model="flowData.flowCoreData.hrs5" :maxlength="45" autocomplete="off" :readonly="(Flg=='VIEW')" clearable></el-input>
				  </el-form-item>
				</el-col>
				<el-col :span="12">
								<el-form-item label="职能负责人：" class="te-item" prop="flowCoreData.hrs4" :rules="[{ required: true, message: '相关审批人不能为空',trigger:'blur'}]">
								  <deng-select-user :value="flowData.flowCoreData.hrs4_V" :CYUserSelectValue="flowData.flowCoreData.CYUserSelectValue_hrs||[]" @submitdata="sethrs($event,'hrs4')" :readonly="(Flg=='VIEW')"/>
								</el-form-item>
				</el-col>
              <el-col :span="24">
                <el-form-item label="营策立项主要内容：" class="te-item" prop="flowCoreData.memo" :rules="[{ required: true, message: '请示内容不能为空',trigger:'blur'}]">
                  <el-input type="textarea" :autosize="{ minRows: 6}" v-model="flowData.flowCoreData.memo" placeholder="请输入请示内容..." :readonly="(Flg=='VIEW')" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- 加载流程其它数据模块 -->
...
export default {
  ...
  name: "flow-flowaddpush-WFYCLXV2Temp1",
  mixins: [myMixin],
  components: {
