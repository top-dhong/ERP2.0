        ...
        <el-col :span="24">
          <el-form :model="flowData" ref="flowData" label-position="left" label-width="110px" class="demo-ruleForm" size="mini">
           ...
           <el-col :span="12">
            ...
            <el-row>
				  <el-col :span="12">
				  <el-form-item label="完成日期：" class="te-item" prop="flowCoreData.date2" :rules="[{ required: true, message: '调整后完成日期',trigger:'blur'}]">
...
export default {
  ...
  name: "flow-flowaddpush-WFProjPlanFinishTemp1",
  mixins: [myMixin],
  components: {
