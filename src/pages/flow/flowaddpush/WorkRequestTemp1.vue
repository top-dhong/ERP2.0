              ...
              <el-col :span="24">
                <el-form-item label="请示类型：" class="te-item" prop="flowCoreData.text1" :rules="[{ required: true, message: '请示类型不能为空',trigger:'blur'}]">
                  <el-radio-group v-model="flowData.flowCoreData.text1" :disabled="(Flg=='VIEW')">
                    <el-radio label="人事类请示"></el-radio>
                    <el-radio label="行政非费用类请示"></el-radio>
                    <el-radio label="行政费用类请示"></el-radio>
                    <el-radio label="合同模板或专用模板请示或营销相关"></el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="16">
                <el-form-item label="终审选择：" class="te-item" prop="flowCoreData.text4" :rules="[{ required: true, message: '终审选择不能为空',trigger:'blur'}]">
                  <el-radio-group v-model="flowData.flowCoreData.text4" :disabled="(Flg=='VIEW')">
                    <el-radio label="总裁"></el-radio>
                    <el-radio label="董事长"></el-radio>
