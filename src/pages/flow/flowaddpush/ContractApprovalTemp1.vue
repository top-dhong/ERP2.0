        ...
        <el-col :span="24">
          <el-form :model="flowData" ref="flowData" label-position="left" label-width="110px" class="demo-ruleForm" size="mini">
			...
			<el-row>
			  ...
			  <el-col :span="8">
			    <el-form-item label="币种：" class="te-item" prop="flowCoreData.text45" :rules="[{ required: true, message: '币种不能为空',trigger:'blur'}]">
			      <el-select v-model="flowData.flowCoreData.text45" placeholder="请选择" style="width: 100%" :disabled="(Flg=='VIEW')">
			...
			<el-row>
			  <el-col :span="8">
			    <el-form-item label="是否含税：" class="te-item" prop="flowCoreData.text49" :rules="[{ required: true, message: '是否含税不能为空',trigger:'blur'}]">
			      <el-radio-group v-model="flowData.flowCoreData.text49" :disabled="(Flg=='VIEW')">
			        <el-radio label="是"></el-radio>
			        <el-radio label="否"></el-radio>
			      </el-radio-group>
			    </el-form-item>
			  ...
			  <el-col :span="8">
			    <el-form-item label="税金：" class="te-item" prop="flowCoreData.amt14" :rules="[{ required: true, message: '税金不能为空',trigger:'blur'}]">
			      <el-input placeholder="请输入税金" v-model="flowData.flowCoreData.amt14" autocomplete="off" :readonly="(Flg=='VIEW')" clearable></el-input>
			    </el-form-item>
			  </el-col>
			</el-row>
			<el-row>
			  <el-col :span="24">
			    <el-form-item label="专业：" class="te-item" prop="flowCoreData.text48" :rules="[{ required: true, message: '专业不能为空',trigger:'blur'}]">
			...
			<el-row>
			  ...
			  <el-col :span="6">
			    <el-form-item label="是否资产采购：" class="te-item" prop="flowCoreData.text40" :rules="[{ required: true, message: '是否资产采购不能为空',trigger:'blur'}]">
			      <el-radio-group v-model="flowData.flowCoreData.text40" :disabled="(Flg=='VIEW')">
			        <el-radio label="是"></el-radio>
			        <el-radio label="否"></el-radio>
			      </el-radio-group>
			    </el-form-item>
