    ...
    <template slot="header">
		<el-breadcrumb separator="/">
		  ...
		  <el-breadcrumb-item :to="{ path: '/flow/flowadd' }">新建流程</el-breadcrumb-item>
		   <el-breadcrumb-item>{{flowTypeName}}</el-breadcrumb-item>
		</el-breadcrumb>
	</template>
     <div>
		 <el-row>
				 	...
				 	<el-row>
						<el-col :span="24">
							<el-form-item label="请示内容：" class="te-item" prop="flowCoreData.memo" :rules="[{ required: true, message: '请示内容不能为空',trigger:'blur'}]">
								<el-input type="textarea"  :autosize="{ minRows: 8}" v-model="flowData.flowCoreData.memo" placeholder="请输入请示内容..." clearable></el-input>
							</el-form-item>
						</el-col>
					</el-row>
				 	<!-- 加载流程其它数据模块 -->
...
<script>
    ...
    export default {
		name:"flow-flowaddpush-WorkRequestTemp",
		mixins:[myMixin],
		components: { 
