      ...
      <el-row>
        <el-col :span="24">
          <el-form :model="flowData" ref="flowData" label-position="left" label-width="110px" class="demo-ruleForm" size="mini">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="计划日期：" class="te-item" prop="flowCoreData.text2" :rules="[{ required: true, message: '计划完成日期不能为空',trigger:'blur'}]">
                  <el-date-picker style="width:100%;" v-model="flowData.flowCoreData.text2" :readonly="(Flg=='VIEW')" type="date" placeholder="请选择"/>
                </el-form-item>
              </el-col>
			  <el-col :span="12">
			 ...
			 <el-row>
				 <el-col :span="12">
				   <el-form-item label="完成事项：" class="te-item" prop="flowCoreData.text4" :rules="[{ required: true, message: '完成事项不能为空',trigger:'blur'}]">
				     <el-input type="text" v-model="flowData.flowCoreData.text4" placeholder="请完成事项..." :readonly="(Flg=='VIEW')" clearable></el-input>
				   </el-form-item>
				 </el-col>
			<el-col :span="12">
			...
			<el-row>
			  <el-col :span="12">
			    <el-form-item label="完成日期：" class="te-item" prop="flowCoreData.date2" :rules="[{ required: true, message: ' 完成日期不能为空',trigger:'blur'}]">
			      <el-date-picker style="width:100%;" v-model="flowData.flowCoreData.date2" :readonly="(Flg=='VIEW')" type="date" placeholder="请选择"/>
			    </el-form-item>
			  </el-col>
			  <el-col :span="12">
			    <el-form-item label="完成标准：" class="te-item" prop="flowCoreData.text21" :rules="[{ required: true, message: '完成标准',trigger:'blur'}]">
			      <el-input type="text" v-model="flowData.flowCoreData.text21" :readonly="(Flg=='VIEW')" clearable></el-input>
			    </el-form-item>
			  </el-col>
			 </el-row> 
			  ...
			  <el-col :span="12">
			    <el-form-item label="计划部确认：" class="te-item" prop="flowCoreData.text5" :rules="[{ required: true, message: '',trigger:'blur'}]">
			      <el-radio-group v-model="flowData.flowCoreData.text5" :disabled="(Flg=='VIEW')">
			        <el-radio label="0">按时完成</el-radio>
			        <el-radio label="1">超期完成</el-radio>
...
export default {
  ...
  name: "flow-flowaddpush-WorkfinishTemp1",
  mixins: [myMixin],
  components: {
