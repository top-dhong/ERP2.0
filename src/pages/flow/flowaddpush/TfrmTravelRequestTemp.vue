  ...
  <d2-container>
    <template slot="header">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>{{flowTypeName||'差旅申请'}}</el-breadcrumb-item>
      </el-breadcrumb>
    </template>
    <div>
      <el-row>
          ...
          >
			...
			<el-row>
			  <el-col :span="16">
			    ...
			    >
			      <el-input v-model="flowData.flowCoreData.amt1"></el-input>
			    </el-form-item>
			  </el-col>
			  <el-col :span="8">
			    <el-form-item
			      label="会议类别："
			      class="te-item"
			      prop="flowBaseData.meet1"
			      :rules="[{ required: true, message: '会议类别不能为空',trigger:'blur'}]"
			    >
			  			<el-select v-model="flowData.flowBaseData.meet1" placeholder="请选择" style="width:100%">
			  		      <el-option
			...
			<el-row>
				<el-col :span="8">
					<el-form-item label="主持人：" class="te-item" prop="flowCoreData.text1" :rules="[{ required: true, message: '主持人不能为空',trigger:'blur'}]">
						<!-- <el-input v-model="flowData.flowCoreData.hrs" clearable></el-input> -->
						<deng-select-user @submitdata="sethrs" :canMark="'one'"></deng-select-user>
					</el-form-item>
				</el-col>
				<el-col :span="16">
					<el-form-item label="出席人：" class="te-item" prop="flowCoreData.text2" :rules="[{ required: true, message: '出席人不能为空',trigger:'blur'}]">
						<!-- <el-input v-model="flowData.flowCoreData.hrs" clearable></el-input> -->
						<deng-select-user @submitdata="sethrs"></deng-select-user>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
				<el-col :span="24">
					<el-form-item label="抄送人：" class="te-item" prop="flowCoreData.text3" :rules="[{ required: true, message: '抄送人不能为空',trigger:'blur'}]">
						<!-- <el-input v-model="flowData.flowCoreData.hrs" clearable></el-input> -->
						<deng-select-user @submitdata="sethrs"></deng-select-user>
					</el-form-item>
				</el-col>
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="会议地点：" class="te-item" prop="flowCoreData.text4" :rules="[{ required: true, message: '会议地点不能为空',trigger:'blur'}]">
						<el-input v-model="flowData.flowCoreData.text4" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="会议时间：" class="te-item" prop="flowCoreData.text5" :rules="[{ required: true, message: '会议时间不能为空',trigger:'blur'}]">
						<el-date-picker v-model="flowData.flowCoreData.text5" type="date" placeholder="选择会议时间" value-format="yyyy-MM-dd" style="width: 100%;"/>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
				<el-col :span="12">
					<el-form-item label="编号：" class="te-item" prop="flowCoreData.text6" :rules="[{ required: true, message: '编号不能为空',trigger:'blur'}]">
						<el-input v-model="flowData.flowCoreData.text6" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="密级：" class="te-item" prop="flowCoreData.text7" :rules="[{ required: true, message: '密级不能为空',trigger:'blur'}]">
						<el-radio-group v-model="flowData.flowCoreData.text7">
								...
								<el-radio-button label="机密"></el-radio-button>
								<el-radio-button label="绝密"></el-radio-button>
						</el-radio-group>
					</el-form-item>
				</el-col>
			</el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item
                  ...
                  :rules="[{ required: true, message: '纪要内容不能为空',trigger:'blur'}]"
                >
                  <el-input
                    type="textarea"
                    :autosize="{ minRows: 6}"
...
export default {
  name: "flow-flowaddpush-TfrmTravelRequestTemp",
  mixins: [myMixin],
  components: {
