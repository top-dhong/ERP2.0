      ...
      <el-row>
        <el-col :span="24">
          <el-form :model="flowData" ref="flowData" label-position="left" label-width="110px" class="demo-ruleForm" size="mini">
			...
			<el-row>
			  <el-col :span="24">
			    <el-form-item label="职能负责人：" class="te-item" prop="flowCoreData.hrs4" :rules="[{ required: true, message: '相关职能负责人不能为空',trigger:'blur'}]">
			      <deng-select-user :value="flowData.flowCoreData.hrs4_V" :CYUserSelectValue="flowData.flowCoreData.CYUserSelectValue_hrs4||[]" @submitdata="sethrs($event,'hrs4')" :readonly="(Flg=='VIEW')"/>
			    </el-form-item>
			  </el-col>
			</el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item label="相关审批人：" class="te-item" prop="flowCoreData.hrs1" :rules="[{ required: true, message: '相关审批人不能为空',trigger:'blur'}]">
	   ...
	   <el-row>
	     <el-col :span="24">
	       <el-form-item label="业务类型1：" class="te-item" prop="flowCoreData.text1" :rules="[{ required: true, message: '业务类型1不能为空',trigger:'blur'}]">
	         <el-radio-group v-model="flowData.flowCoreData.text1" :disabled="(Flg=='VIEW')">
	           <el-radio label="工程类"></el-radio>
	           <el-radio label="非工程类"></el-radio>
	         </el-radio-group>
	       </el-form-item>
	     </el-col>
	   </el-row>
	   ...
	   <el-row>
	     <el-col :span="24">
	       <el-form-item label="业务类型2：" class="te-item" prop="flowCoreData.text2" :rules="[{ required: true, message: '业务类型2不能为空',trigger:'blur'}]">
	         <el-radio-group v-model="flowData.flowCoreData.text2" :disabled="(Flg=='VIEW')">
	           <el-radio label="经济类"></el-radio>
	           <el-radio label="非经济类"></el-radio>
	         </el-radio-group>
	       </el-form-item>
	     </el-col>
	   </el-row>
            <el-row>
              <el-col :span="24">
                <el-form-item label="备注：" class="te-item" prop="flowCoreData.memo" :rules="[{ required: true, message: '备注内容不能为空',trigger:'blur'}]">
                  <el-input type="textarea" :autosize="{ minRows: 6}" v-model="flowData.flowCoreData.memo" placeholder="请输入内容..." :readonly="(Flg=='VIEW')" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!-- 加载流程其它数据模块 -->
...
export default {
  name: "flow-flowaddpush-WFStampSealTemp1",
  mixins: [myMixin],
  components: {
  ...
  data() {
    return {
		...
		flowData: {
			flowBaseData: {},
			flowCoreData: { CYUserSelectValue_hrs1: [],CYUserSelectValue_hrs4: [], hrs_V: "" },
			relaFlowObj: [],
			annexData: [],
			agree: "同意",
			opinionData: "",
